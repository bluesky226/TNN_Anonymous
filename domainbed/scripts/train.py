...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', type=str, default="Fetal_8")
    
    

    parser.add_argument('--input_dir', default ='./Messidor_train_output_t3a_r18_adanpc/',  type=str)
    
    parser.add_argument('--output_dir', default ='./Fetal_ds_train_output_adanpc_erm_4/',  type=str)
    ...
    for step in range(start_step, n_steps):
        ...
        if (step % checkpoint_freq == 0) or (step == n_steps - 1):
            ...
            for name, loader, weights in evals:
                if args.algorithm == 'KNN':
                    algorithm.eval_knn.memory = algorithm.eval_knn.memory[:algorithm.eval_knn.queue_size,:]
